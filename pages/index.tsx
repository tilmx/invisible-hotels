	...
	return (
		<BackgroundColor color={color || Color.Background}>
			...
			<Wrapper>
				...
				<Text size={TextSize.Large} serif>are all the <ColoredText color={Color.Blue} accentStyle={AccentStyle.Scribbled} onMouseEnter={() => setColor(Color.Blue)} onMouseOut={() => setColor(undefined)}>lovely</ColoredText>, <ColoredText color={Color.Green} accentStyle={AccentStyle.Circled} onMouseEnter={() => setColor(Color.Green)} onMouseOut={() => setColor(undefined)}>minimalistic</ColoredText> and <ColoredText color={Color.Yellow} accentStyle={AccentStyle.Underlined} onMouseEnter={() => setColor(Color.Yellow)} onMouseOut={() => setColor(undefined)}>fancy</ColoredText> hotels & apartments where we stayed already — or would love to.</Text>
...
const ColoredText: FunctionComponent<{ accentStyle?: AccentStyle; color: string; children?: React.ReactNode; onMouseEnter?: MouseEventHandler; onMouseOut?: MouseEventHandler }> = props => {
	return (
		<StyledSpan color={props.color} onMouseEnter={props.onMouseEnter} onMouseOut={props.onMouseOut} >
			...
			{props.accentStyle === AccentStyle.Circled &&
				<svg width="435" height="96" viewBox="0 0 435 96" fill="none" xmlns="http://www.w3.org/2000/svg">
					<path d="M195.314 18.2016C130.524 18.0539 0.756665 26.2648 0.00366236 60.2895C-0.937591 102.82 179.783 107.25 276.261 97.9468C372.74 88.6432 467.806 52.3147 424.038 27.505C389.024 7.6573 228.414 5.05819 152.487 6.2396" stroke="currentColor" stroke-width="8" stroke-linecap="round" />
				</svg>
			}
			...
			{props.accentStyle === AccentStyle.Underlined &&
				<svg width="202" height="96" viewBox="0 0 202 96" fill="none" xmlns="http://www.w3.org/2000/svg">
					<path d="M8 91.5054C27.9364 88.8217 193 81.6758 193 94.0053C193 99.6053 94.3333 102.339 45 103.005" stroke="currentColor" stroke-width="8" stroke-linecap="round" />
				</svg>
			}
		</StyledSpan>
	)
